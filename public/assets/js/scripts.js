    ...
    (r.ClassNavMenu = function () {
        ...
        (r.TGL.ddmenu = function (t, e) {
            var n = t || ".nk-menu-toggle",
                ...
                a = e ? h(i, e) : i;
            u(n).on("click", function (t) {
                (r.Win.width < p.lg || u(this).parents().hasClass(_sidebar) || u(this).parents().hasClass(_aside)) && r.Toggle.dropMenu(u(this), a), t.preventDefault();
            });
        }),
        (r.TGL.showmenu = function (t, e) {
            var n = u(t || ".nk-nav-toggle"),
                i = u("[data-content]"),
                a = i.hasClass(g) ? p.lg : p.xl,
                o = { active: "toggle-active", content: f + "-active", body: "nav-shown", overlay: "nk-header-overlay", break: a, close: { profile: !0, menu: !1 } },
                s = e ? h(o, e) : o;
            n.on("click", function (t) {
        ...
        (r.OtherInit = function () {
            r.PassSwitch(), r.CurrentLink(), r.LinkOff(".is-disable"), r.ClassNavMenu(), r.SetHW("[data-height]", "height"), r.SetHW("[data-width]", "width");
        }),
        (r.Ani.init = function () {
