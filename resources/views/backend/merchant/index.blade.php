                        ...
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <p>Welcome to your Merchant panel</p>
                                </div>
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                {{-- <div class="drodown">
                                                    <a href="#" class="dropdown-toggle btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                                                ...
                                                <a href="#" class="btn btn-icon btn-primary btn-sm" style="padding-right: 10px;"><em class="icon ni ni-plus"></em> Add Parcel</a>
                                            </li>
                                        </ul>
                                ...
                                <div class="card card-bordered card-full">
                                    ...
                                    <ul class="nk-activity">
                                        <li class="nk-activity-item">
                                            <div class="nk-activity-media user-avatar bg-success"><img src="{{ asset('public/assets/images/avatar/c-sm.jpg')}}" alt=""></div>
                                        ...
                                        <li class="nk-activity-item">
                                            <div class="nk-activity-media user-avatar bg-purple"><img src="{{ asset('public/assets/images/avatar/d-sm.jpg')}}" alt=""></div>
                                            <div class="nk-activity-data">
