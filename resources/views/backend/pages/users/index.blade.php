                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Team Member</h3>
                                <div class="nk-block-des text-soft">
                                    <p>You have total {{ $users->count() }} Team Members</p>
                                </div>
                                    ...
                                    <div class="toggle-expand-content" data-content="more-options">
                                        <ul class="nk-block-tools g-3">
                                            <li class="nk-block-tools-opt">
                                                <a href="{{ route('users.create') }}" class="btn btn-icon btn-primary d-md-none" data-toggle="modal" data-target=".bd-example-modal-lg">
                                                    <em class="icon ni ni-plus"></em>
                                                </a>
                                                <a href="{{ route('users.create') }}" class="btn btn-primary d-none d-md-inline-flex btn-sm">
                                                    <em class="icon ni ni-plus"></em>
                                                    <span>Add</span>
                                                </a>
                                            </li>
                                                    ...
                                                    @foreach ($users as $key => $user)
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col text-center">
                                                                <a href="{{ route('users.edit', $user->id) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit user">
