                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Edit Role - <span class="badge badge-dim badge-pill badge-outline-primary">{{ ucfirst($user->name) }}</span></h3>
								                        ...
								                        <div class="form-group">
								                            ...
								                            <div class="form-control-wrap">
								                                <div class="custom-control custom-control-sm custom-checkbox" style="font-weight: bold;">
								                                    <input type="checkbox" class="custom-control-input" id="permissionCheckAll" value="1" {{ App\User::roleHasPermissions($user, $all_permissions) ? 'checked' : '' }}>
