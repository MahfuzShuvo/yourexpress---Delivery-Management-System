                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Edit Merchant</h3>
                                                ...
                                                <div class="row ml-2 mr-2">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $merchant->name }}" id="name" name="name" placeholder="abc" >
                                                                @error('name')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('phone') is-invalid @enderror" value="{{ $merchant->phone }}" id="phone" name="phone" placeholder="0123456789" >
                                                                @error('phone')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="email" class="form-control" value="{{ $merchant->email }}" id="email" name="email" placeholder="abc@domain.com" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('identity') is-invalid @enderror" id="identity" name="identity" value="{{ $merchant->identity }}" placeholder="NID / Passport no.">
                                                                @error('identity')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="row" style="margin-bottom: 8px;">
                                                            <div class="col-md-4" style="text-align: center;">
                                                                <img src="{{ asset($merchant->photo) }}" width="200px;">
                                                            </div>
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6" style="border-left: 1px solid #fce4d2;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('company') is-invalid @enderror" id="company" name="company" value="{{ $merchant->company }}" placeholder="Compnay">
                                                                @error('company')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('website') is-invalid @enderror" id="website" name="website" value="{{ $merchant->website }}" placeholder="www.company-domain.com">
                                                                @error('website')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ $merchant->address }}" placeholder="123 company-address">
                                                                @error('address')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control @error('pickup') is-invalid @enderror" id="pickup" name="pickup" value="{{ $merchant->pickup }}" placeholder="123 pickup-address">
                                                                @error('pickup')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label">Pickup Type <small>({{ $merchant->pickup_type }})</small></label>
                                                            <div class="form-control-wrap">
                                                                <select class="form-control @error('pickup_type') is-invalid @enderror" id="select2_pickup" name="pickup_type[]" data-search="on" multiple="multiple" data-placeholder="Change pickup type">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label">Delivery Zone <small>({{ $merchant->zone }})</small></label>
                                                            <div class="form-control-wrap">
                                                                <select class="form-control @error('zone') is-invalid @enderror" id="select2_zone" name="zone[]" data-search="on" multiple="multiple" data-placeholder="Change delivery zone">
