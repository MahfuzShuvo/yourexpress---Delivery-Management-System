                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <select class="form-control" id="select2_merchant" name="merchant_id" data-search="on" data-placeholder="Choose a merchant for create parcel">
                                                                    <option></option>
                                                                    @foreach (App\Merchant::all() as $merchant)
                                                                        <option value="{{ $merchant->id}}" {{ ($parcel->merchant_id == $merchant->id) ? 'selected':'' }}>{{ $merchant->name }} <small>({{ $merchant->company }})</small></option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
